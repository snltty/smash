...
namespace smash.plugins.hijack
{
    ...
    public enum NF_FLAGS
    {
        ...
        NFF_DISABLE_AUTO_REGISTER = 4, // Dont' try to register the driver automatically
        NFF_DISABLE_AUTO_START = 8,    // Dont' try to start the driver automatically
    };
    ...
    **/
    ...
    public struct NF_RULE_EX
    {
        ...
        public NF_PORT_RANGE localPortRange; // Local port(s)
        public NF_PORT_RANGE remotePortRange; // Remote port(s)
    ...
    **/
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void cbd_tcpReceive(ulong id, nint buf, int len);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void cbd_tcpSend(ulong id, nint buf, int len);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    ...
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void cbd_udpReceive(ulong id, nint remoteAddress, nint buf, int len, nint options);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void cbd_udpSend(ulong id, nint remoteAddress, nint buf, int len, nint options);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void cbd_udpCanReceive(ulong id);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void cbd_udpCanSend(ulong id);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void cbd_ipReceive(nint buf, int len, ref NF_IP_PACKET_OPTIONS ipOptions);
    [UnmanagedFunctionPointer(CallingConvention.Cdecl)]
    delegate void cbd_ipSend(nint buf, int len, ref NF_IP_PACKET_OPTIONS ipOptions);
    ...
    public interface NF_EventHandler
    {
        ...
        void udpReceive(ulong id, nint remoteAddress, nint buf, int len, nint options, int optionsLen);
        void udpSend(ulong id, nint remoteAddress, nint buf, int len, nint options, int optionsLen);
    ...
    {
        void ipReceive(nint buf, int len, ref NF_IP_PACKET_OPTIONS ipOptions);
        void ipSend(nint buf, int len, ref NF_IP_PACKET_OPTIONS ipOptions);
    };
    ...
    class NF_EventHandlerFwd
    {
        ...
        public static void tcpReceive(ulong id, nint buf, int len)
        {
            m_pEventHandler.tcpReceive(id, buf, len);
        }
        public static void tcpSend(ulong id, nint buf, int len)
        {
        ...
        public static void udpReceive(ulong id, nint remoteAddress, nint buf, int len, nint options)
        {
            ...
            {
                m_pEventHandler.udpReceive(id, remoteAddress, buf, len, (nint)null, 0);
            }
        }
        public static void udpSend(ulong id, nint remoteAddress, nint buf, int len, nint options)
        {
            if (options.ToInt64() != 0)
            {
                NF_UDP_OPTIONS optionsCopy = (NF_UDP_OPTIONS)Marshal.PtrToStructure(options, typeof(NF_UDP_OPTIONS));
            ...
            {
                m_pEventHandler.udpSend(id, remoteAddress, buf, len, (nint)null, 0);
            }
        }
    ...
    class NF_IPEventHandlerFwd
    {
        ...
        public static void ipReceive(nint buf, int len, ref NF_IP_PACKET_OPTIONS ipOptions)
        {
            m_pEventHandler.ipReceive(buf, len, ref ipOptions);
        }
        public static void ipSend(nint buf, int len, ref NF_IP_PACKET_OPTIONS ipOptions)
        {
    ...
    public class NFAPI
    {
        private static nint m_pEventHandlerRaw = (nint)null;
        ...
        **/
        ...
        public static NF_STATUS nf_setRules(NF_RULE[] rules)
        {
            ...
            nint ptr = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(NF_RULE)) * rules.Length);
            ...
            for (int i = 0; i < rules.Length; i++)
            {
                ...
                Marshal.StructureToPtr(pRule, new nint(longPtr), false);
        ...
        **/
        ...
        public static NF_STATUS nf_setRulesEx(NF_RULE_EX[] rules)
        {
            ...
            nint ptr = Marshal.AllocHGlobal(Marshal.SizeOf(typeof(NF_RULE_EX)) * rules.Length);
            ...
            return nf_setRulesEx(ptr, rules.Length);
        }
        ...
        **/
        public static unsafe string nf_getProcessNameFromKernel(uint processId)
        {
            ...
            fixed (char* p = buf)
            {
                if (nf_getProcessNameFromKernel(processId, (nint)p, buf.Length))
                {
        ...
        **/
        public static unsafe string nf_getProcessName(uint processId)
        {
            ...
            fixed (char* p = buf)
            {
                if (nf_getProcessNameW(processId, (nint)p, buf.Length))
                {
                    return Marshal.PtrToStringUni((nint)p);
                }
            }
